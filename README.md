...
- **한자 훈음 자동 표시 (Updated):**
    ...
    - **사용자 사전 편집 UI:** Streamlit 앱 사이드바에서 한자 뜻을 직접 수정 및 추가할 수 있는 편집기 제공.
    - **학습 레이아웃:** 원문 아래에는 정답 훈음을 깔끔하게 표시하고, 필사 격자 아래에는 직접 훈음을 써볼 수 있는 **빈 박스**를 제공하여 학습 효과 극대화.
- **디자인 가이드:** 격자 셀 내부에 십자(+) 점선 가이드 포함, 글자 수에 따라 셀 크기 자동 조절 (20~30mm). 레이아웃 최적화를 통해 음독과 해석이 겹치지 않게 정렬.
